...
typedef struct {
    ...
    GLuint shader_reluAndsqr_vec4;
    GLuint shader_variance_before_sum;
    GLuint shader_rwkv_att_rkv_vec4;
    GLuint shader_rwkv_att_wkv_vec4;
    GLuint shader_rwkv_ffn_vec4;
    GLuint shader_layerNorm_inplace;
    GLuint shader_layerNorm;
    GLuint shader_vecxvec_vec4;
    GLuint shader_rwkv_carry_vec4;
